...
export const pages = {
  page: {
    ...
    workflows: {
      ...
      subtitle: 'Argo 流程檢視',
      description: '追蹤 Argo workflows 狀態、檢視 DAG 進度與操作生命週期。',
      searchPlaceholder: '搜尋 workflows...',
      refresh: '重新整理',
      loading: '讀取 workflows 中...',
      empty: '目前沒有 workflows。',
      noTime: '尚無時間',
      columns: {
        name: 'Workflow',
        status: '狀態',
    ...
    workflowDetail: {
      title: 'Workflow 概覽',
      breadcrumb: 'Workflow',
      subtitle: 'Argo Workflow 詳細',
      noTime: '尚無時間',
      loading: '讀取 workflow 中...',
      graphTitle: '執行圖',
      nodeTitle: '最新節點',
      noNodes: '尚無狀態節點，workflow 啟動後會自動產生。',
      actions: {
        suspend: '暫停',
        resume: '繼續',
        terminate: '終止',
