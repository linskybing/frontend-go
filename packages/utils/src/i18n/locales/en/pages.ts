...
export const pages = {
  page: {
    ...
    workflows: {
      title: 'Workflow Control Room',
      breadcrumb: 'Workflows',
      subtitle: 'Argo Pipeline View',
      description: 'Track live Argo workflows, inspect DAG progress, and manage lifecycle actions.',
      searchPlaceholder: 'Search workflows...',
      refresh: 'Refresh',
      loading: 'Loading workflows...',
      empty: 'No workflows found.',
      noTime: 'No timestamp yet',
      columns: {
        name: 'Workflow',
        status: 'Status',
        updated: 'Last update',
    ...
    workflowDetail: {
      ...
      breadcrumb: 'Workflow',
      subtitle: 'Argo Workflow Detail',
      noTime: 'No timestamp yet',
      loading: 'Loading workflow...',
      graphTitle: 'Execution Graph',
      nodeTitle: 'Recent Nodes',
      noNodes: 'No status nodes yet. Argo will populate once the workflow starts.',
      actions: {
        suspend: 'Suspend',
        resume: 'Resume',
        terminate: 'Terminate',
