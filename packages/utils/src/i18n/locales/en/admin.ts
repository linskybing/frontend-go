  ...
  admin: {
    ...
    storage: {
      ...
      project: {
        ...
        createSuccess: 'Group storage created successfully',
        createGuideTitle: 'Create Group Storage',
        createGuideDesc: 'Create a new PVC for group storage.',
