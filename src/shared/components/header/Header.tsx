...
import SearchBar from '@/features/forms/components/form/SearchBar'; // New import
    ...
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <div className="hidden lg:block overflow-visible w-full max-w-sm">
            <SearchBar
        ...
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            <button
              onClick={() => toggleLanguage()}
              className="ml-3 hidden lg:inline-flex items-center gap-2 rounded-full bg-accent-600 px-3 py-1 text-xs font-semibold text-white shadow-sm hover:bg-accent-500 relative z-50 overflow-visible"
              aria-label={t('language.aria')}
              title={language === 'zh' ? t('language.switchToEn') : t('language.switchToZh')}
            >
